  ...
  <div class="settings-grid">
    ...
    <div class="card">
      ...
      <div class="form-group">
        ...
        <input type="text" name="telegram_url" value="<?php echo htmlspecialchars($get('telegram_url','https://t.me/dollartreesupport'));?>" class="form-control" placeholder="https://t.me/dollartreesupport">
      </div>
      <div class="form-group">
