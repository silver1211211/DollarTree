...
<head>
    ...
    <style>
        ...
        *,*::before,*::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        /* ── DEPOSIT CONTAINER ── */
        .deposit-container { display:none; }
...
<div class="header">
    ...
    <div class="header-tag"><i class="fa-solid fa-circle-dollar-to-slot"></i> USDT</div>
</div>
...
<div class="section">
    ...
    <div class="network-grid">
        <button class="network-btn active" onclick="selectNetwork('TRON',this)">
    ...
    <div id="depositInfo" class="deposit-info">
        ...
        <div class="instructions">
            ...
            <div class="instruction-item">
                ...
                <div>Only send USDT through the selected network — other tokens will be lost permanently.</div>
            </div>
            <div class="instruction-item">
                <i class="fa-solid fa-arrow-down-to-line"></i>
                <div><?php echo t('minimum_deposit','Minimum deposit is 2 USDT. Smaller amounts will not be credited.'); ?></div>
            </div>
            <div class="instruction-item">
...
<script>
    ...
    async function getDepositAddress(network) {
        ...
        try {
            const response = await fetch('../api/get_deposit_address.php', {
                ...
                body: JSON.stringify({ currency: 'USDT', network: network })
            });
    ...
    window.addEventListener('load', function () {
        var defaultBtn = document.querySelector('.network-btn.active');
        selectNetwork('TRON', defaultBtn);
    });
